...
public class TransactionTest {
    ...
    private static final String HASH_OF_TRYTES_VALID_FLAGS = "OZYZPYDFVVARJWLCILUJFEJRHPWNRMJNGHCXTKIBOZMFLRKHHTJMICSDMOFVBISVDYSWHSVBACHRQGPZ9"; //"NFWYEUEPDKJLDKLMXQAABMFDWANBCCRSNMWPRHQVDLRPF9YORK9YWRQ9XBPTWYWSFKFLZGNKKPYLMUOOT"; <-- 123 rounds

    @Test(expected = Transaction.InvalidTransactionFlagException.class)
    public void testInvalidFlags() {
        new Transaction(TRYTES_INVALID_FLAGS, null);
    }
    ...
    public void testTransactionEncodingDecoding() {
        Transaction original = new Transaction(TRYTES_VALID_FLAGS, null);
        Transaction copy = new Transaction(original.trytes, null);
